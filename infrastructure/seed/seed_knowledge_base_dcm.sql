...
USING (
  SELECT column1 AS DOC_ID, column2 AS TITLE, column3 AS CONTENT, column4 AS CATEGORY
  FROM VALUES
    ('doc-001', 'Order Fulfillment Process',
     ...
     'Operations'),
    ('doc-002', 'Customer Segmentation Policy',
     ...
     'Sales Policy'),
    ('doc-003', 'Discount Rules and Authorization',
     ...
     'Finance Policy'),
    ('doc-004', 'Returns and Refund Policy',
     ...
     'Operations'),
    ('doc-005', 'Regional Sales Strategy 2024',
     ...
     'Strategy'),
    ('doc-006', 'Shipping and Logistics Guidelines',
     ...
     'Operations')
) AS source(DOC_ID, TITLE, CONTENT, CATEGORY)
...
WHEN NOT MATCHED THEN
  INSERT (DOC_ID, TITLE, CONTENT, CATEGORY)
  VALUES (source.DOC_ID, source.TITLE, source.CONTENT, source.CATEGORY);
